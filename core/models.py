...
class Questions(models.Model):
    """ Вопросы для опросов """
    polls_id = models.ForeignKey(PollsDB, on_delete=models.CASCADE, related_name="questions", verbose_name="Название опроса")
...
#     poll_id = polls_id = models.ForeignKey(PollsDB, on_delete=models.CASCADE)
...
class UserAnswer(models.Model):
    ...
    answer_text = models.CharField(max_length=200, verbose_name="Текст ответа пользователя", null=True)